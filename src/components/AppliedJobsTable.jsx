...
const AppliedJobsTable = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 rounded-lg ">
            ...
            <Table className="rounded-lg shadow overflow-hidden">
                <TableCaption className="text-gray-500">
                    A list of jobs you have applied for recently.
                </TableCaption>
                <TableHeader>
                    <TableRow>
                        <TableHead className="text-left text-blue-800">
                            Application Date
                        </TableHead>
                        <TableHead className="text-left text-blue-800">Company</TableHead>
                        <TableHead className="w-[200px] text-left text-blue-800">
                            Job Title
                        </TableHead>
                        <TableHead className="text-left text-blue-800">Status</TableHead>
                ...
                <TableBody>
                    {dummy.map((item,index) => (
                        ...
                        >
                            ...
                            <TableCell>
                                <Badge
                                    className={`py-1 px-3 rounded-full text-white ${item.status === "Accepted"
                                            ? "bg-green-500"
