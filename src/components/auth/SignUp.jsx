...
import { USER_API_END_POINT } from "@/utils/constant"; // Assuming constant is defined in utils
...
const SignUp = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 py-10">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            className="w-full px-4 py-3 border rounded-lg cursor-pointer shadow-sm text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                        />
                        {errors.fullName && (
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            className="w-full px-4 py-3 border rounded-lg shadow-sm cursor-pointer text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                        />
                        {errors.email && (
                    ...
                    <Button
                        type="submit"
                        className="w-full py-3 bg-indigo-500 text-white text-lg font-semibold rounded-lg transition-all duration-300 hover:bg-indigo-600 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-400"
